    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-secondary-50">
                            ...
                            {mergedRecentJobs && mergedRecentJobs.length > 0 ? (
                                        ...
                                        >
                                            <div className="p-6">
                                                ...
                                                <div className="flex items-center gap-1.5 mb-3 flex-wrap">
                                                    {job.is_urgent && (
                                                        <span
                                                            className="inline-flex items-center gap-1 px-2 py-1 bg-red-100 text-red-700 rounded text-xs font-semibold">
                              ...
                              ACİL
                                                    ...
                                                    {isExternal && domainInfo && (
                                                        <span
                                                            className={`inline-flex items-center gap-1 px-2 py-1 ${domainInfo.bgColor} ${domainInfo.color} rounded text-xs font-semibold`}>
                              <ExternalLink className="h-3 w-3"/>
                                                ...
                                                <div className="flex items-start gap-3 mb-4">
                                                    {(job.companies as any)?.logo_url ? (
                                                        ...
                                                        <div
                                                            className="w-14 h-14 rounded-lg bg-secondary-100 border border-secondary-200 flex items-center justify-center flex-shrink-0">
                                                ...
                                                {/* Location & Time */}
                                                <div
                                                    className="flex items-center gap-3 text-sm text-secondary-500 mb-4">
                              ...
                              {JOB_POSITION_LABELS[job.position_type as JobPositionType]}
                                                    ...
                                                    {job.venue_type && VENUE_TYPE_LABELS[job.venue_type as VenueType] && (
                                                        <span
                                                            className="px-2 py-1 text-xs font-medium bg-secondary-100 text-secondary-700 rounded">
                              ...
                              {job.work_type === 'full_time' ? 'Tam Zamanlı' :
                                      ...
                                      job.work_type === 'contract' ? 'Sözleşmeli' :
                                          job.work_type === 'freelance' ? 'Freelance' :
                                              job.work_type === 'internship' ? 'Staj' : job.work_type}
                                                ...
                                                {!isExternal && (
                                                    <div
                                                        className="flex items-center gap-3 text-xs text-secondary-500 mb-3">
                                                    ...
                                                    <div className="pt-3 border-t border-secondary-100">
                                                        <p className="text-base font-semibold text-green-700">
                                                            ...
                                                            {job.salary_max && job.salary_max !== job.salary_min && (
                                                                <span
                                                                    className="text-secondary-500 font-normal"> - {job.salary_max.toLocaleString('tr-TR')} TL</span>
                                                            )}
                                                        </p>
                                                    </div>
                                                )}
                                ...
                                <div
                                    className="col-span-full text-center py-20 bg-white rounded-2xl border border-secondary-200">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4">
                            {popularPositions.map((pos) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`w-14 h-14 ${pos.bgColor} rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform`}>
                                            <IconComponent className={`h-7 w-7 ${pos.color}`}/>
                                        </div>
                                        <span
                                            className="text-sm font-medium text-secondary-700 text-center group-hover:text-primary-600 transition-colors">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                {/* Icon */}
                                                <div
                                                    className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:shadow transition-shadow">
                                                    <IconComponent
                                                        className="h-6 w-6 text-secondary-600 group-hover:text-primary-600 transition-colors"/>
                                                </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                            {topCities && topCities.length > 0 ? (
                                topCities.map((city) => (
                                    ...
                                    >
                                        <div
                                            className="w-10 h-10 bg-secondary-100 group-hover:bg-primary-100 rounded-lg flex items-center justify-center mx-auto mb-3 transition-colors">
                                            <MapPin
                                                className="h-5 w-5 text-secondary-500 group-hover:text-primary-600 transition-colors"/>
                                        </div>
                                ...
                                <div
                                    className="col-span-full text-center py-8 bg-white rounded-xl border border-secondary-200">
                ...
                <section
                    className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-indigo-800">
                  ...
                  <span
                    ...
                    İşverenler İçin
                                    ...
                                    <p className="text-lg text-primary-100 mb-8">
                                        İlk 3 ilanınız tamamen ücretsiz! Binlerce kalifiye adaya hemen ulaşın ve
                                        hayalinizdeki ekibi kurun.
                                    </p>
              ...
              <span
                  className="inline-block px-4 py-1.5 bg-purple-100 text-purple-700 text-sm font-medium rounded-full mb-4">
                Nasıl Çalışır
              </span>
                            ...
                            <p className="text-base md:text-lg text-secondary-600 max-w-2xl mx-auto">
                                İster iş arıyor olun ister ekibinize yeni üyeler katmak isteyin, birkaç adımda
                                hedefinize ulaşın
                            </p>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: 'Hesabınızı oluşturun, tüm özelliklere sınırsız erişin'
                                        },
                                        {
                                            icon: FileText,
                                            title: 'Profilini Oluştur',
                                            desc: 'Deneyimlerinizi, sertifikalarınızı ve yeteneklerinizi ekleyin'
                                        },
                                        {
                                            icon: Send,
                                            title: 'İlanlara Başvur',
                                            desc: 'Size uygun ilanları bulun ve tek tıkla başvurun'
                                        },
                                        {
                                            icon: CheckCircle,
                                            title: 'İşe Başla',
                                            desc: 'İşverenlerle görüşün ve hayalinizdeki işe başlayın'
                                        },
                                    ].map((step, index) => (
                                        <div key={index} className="flex gap-4">
                                            <div className="relative">
                                                <div
                                                    className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center text-white font-bold shadow-lg">
                                                    {index + 1}
                                                </div>
                                                {index < 3 && (
                                                    <div
                                                        className="absolute top-12 left-1/2 -translate-x-1/2 w-0.5 h-6 bg-primary-200"/>
                                                )}
                                            </div>
                            ...
                            {/* İşverenler İçin */}
                            <div
                                className="bg-gradient-to-br from-secondary-900 to-secondary-800 rounded-3xl p-8 md:p-10 shadow-xl">
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: 'İlk 3 ilanınız tamamen ücretsiz, hemen yayınlayın'
                                        },
                                        {
                                            icon: Users,
                                            title: 'Başvuruları İncele',
                                            desc: 'Binlerce aktif adaydan gelen başvuruları değerlendirin'
                                        },
                                        {
                                            icon: TrendingUp,
                                            title: 'Ekibinizi Güçlendirin',
                                            desc: 'En uygun adayları işe alın ve ekibinizi büyütün'
                                        },
                                    ].map((step, index) => (
                                        <div key={index} className="flex gap-4">
                                            <div className="relative">
                                                <div
                                                    className="w-10 h-10 bg-gradient-to-br from-orange-400 to-red-500 rounded-xl flex items-center justify-center text-white font-bold shadow-lg">
                                                    {index + 1}
                                                </div>
                                                {index < 2 && (
                                                    <div
                                                        className="absolute top-12 left-1/2 -translate-x-1/2 w-0.5 h-6 bg-white/20"/>
                                                )}
                                            </div>
                                            <div className="flex-1 pb-2">
