      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Heading style={h1}>ServiceCareer'e Hoş Geldiniz!</Heading>
          </Section>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              ServiceCareer'e katıldığınız için teşekkür ederiz. Türkiye'nin önde gelen hizmet sektörü iş platformuna hoş geldiniz.
            </Text>
